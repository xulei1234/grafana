...
require (
	...
	github.com/apache/arrow-go/v18 v18.7.0 // @grafana/plugins-platform-backend
	...
	github.com/aws/smithy-go v1.27.4 // @grafana/aws-datasources
	...
	github.com/grafana/grafana-aws-sdk v1.5.3 // @grafana/aws-datasources
	...
	github.com/grafana/grafana-plugin-sdk-go v0.294.0 // @grafana/plugins-platform-backend
	...
	github.com/grafana/pyroscope-go/godeltaprof v0.1.12 // @grafana/observability-traces-and-profiling
	...
	golang.org/x/exp v0.0.0-20260709172345-9ea1abe57597 // @grafana/alerting-backend
