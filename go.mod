...
require (
	...
	github.com/thomaspoignant/go-feature-flag v1.54.1 // @grafana/grafana-backend-group
	...
	go.opentelemetry.io/otel/exporters/otlp/otlplog/otlploggrpc v0.20.0 // indirect; @grafana/grafana-operator-experience-squad
